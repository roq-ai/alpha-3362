...
import { useAssignmentFindFirst, useRoqClient } from 'lib/roq';
...
function AssignmentViewPage() {
  ...
  const queryParams = useMemo<{ include: { course: boolean; student: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useAssignmentFindFirst(queryParams, {}, { disabled: !id });
